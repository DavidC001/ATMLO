"""
This script converts the LogicBench dataset to a format that can be used for circuit discovery 
more easily by having the same number of tokens in the two prompts.
"""
